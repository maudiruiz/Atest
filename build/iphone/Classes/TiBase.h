...
// in simulator we redefine to format for Antiturista Developer console
...
{\
	NSString * exceptionName = [@"org.antiturista." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.antiturista";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIAntituristaNativeItemNone = -1, 
	UIAntituristaNativeItemSpinner = -2,
	UIAntituristaNativeItemProgressBar = -3,
	
	UIAntituristaNativeItemSlider = -4,
	UIAntituristaNativeItemSwitch = -5,
	UIAntituristaNativeItemMultiButton = -6,
	UIAntituristaNativeItemSegmented = -7,
	
	UIAntituristaNativeItemTextView = -8,
	UIAntituristaNativeItemTextField = -9,
	UIAntituristaNativeItemSearchBar = -10,
	
	UIAntituristaNativeItemPicker = -11,
	UIAntituristaNativeItemDatePicker = -12,
	
	UIAntituristaNativeItemInfoLight = -13,
	UIAntituristaNativeItemInfoDark = -14,
	
	UIAntituristaNativeItemDisclosure = -15,
	
	UIAntituristaNativeItemContactAdd = -16
};
