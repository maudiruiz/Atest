 ...
 * Copyright (c) 2009-2011 by Antiturista, Inc. All Rights Reserved.
...
//@interface AntituristaObject : NSObject
//@end

@interface AntituristaObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AntituristaObject class]])
		{
			for (NSString *key in [[(AntituristaObject*)o modules] allKeys])
			{
